	...
	<div class="select-item">
		...
		<div class="right-object">
			...
			<div class="idObject_nameObject">
				<p>Name:</p>
				<span class="nameObject">Hoodie</span> <span>( </span> <span
					class="idObject">H123</span> <span> )</span>
			</div>
			...
			<div class="total-object">
				<button class="subtract-total">
					<ion-icon name="remove"></ion-icon>
				</button>
				<p>0</p>
				<button class="add-total">
					<ion-icon name="add-outline"></ion-icon>
				</button>
			</div>
			<span>Total:</span>
			<div class="price-object"></div>
			<div class="confirm-object">
				<button>Add to cart</button>
			</div>
		</div>
		<button class="close-object">
